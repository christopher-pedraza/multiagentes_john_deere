    ...
    void OnMessage(object sender, MessageEventArgs e)
    {
        try
        {
            ...
            foreach (var entry in agentsData)
            {
                ...
                Debug.Log($"Agente: {agentName}, Tipo: {agentType}, Posición: {positionData[0] * 4.315f}, {positionData[1] * 4.315f}");
                ...
                MainThreadDispatcher.Instance.DispatchToMainThread(() =>
                {
                    ...
                    if (agents.ContainsKey(agentName))
                    {
                        ...
                        agents[agentName].transform.position = new Vector3(positionData[0] * 4.315f + 5.32f, 0.0f, positionData[1] * 4.315f);
                        ...
                        if (agentType == "Cosechadora" || agentType == "Tractor")
                        {
                            ...
                            {
                                agents[agentName].transform.Rotate(0, 180, 0);
                    ...
                    else
                    {
                        if (cosechadoraPrefab != null && tractorPrefab != null)
                        {
                            ...
                            {
                                newAgent = Instantiate(cosechadoraPrefab, new Vector3(positionData[0] * 4.315f +5.32f, 0.0f, positionData[1]* 4.315f), Quaternion.identity);
                            }
                            else if (agentType == "Tractor")
                            {
                                newAgent = Instantiate(tractorPrefab, new Vector3(positionData[0]* 4.315f + 5.32f, 0.0f, positionData[1]* 4.315f), Quaternion.identity);
                            }
                            else
                            {
